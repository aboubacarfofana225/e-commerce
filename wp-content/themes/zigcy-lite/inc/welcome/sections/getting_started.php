	<div class="theme-steps-list-wrap two-col">
		...
		<div class="theme-steps col">
			<div class="step-1-right recommend-col">
				...
				array(
					...
					'link' => add_query_arg( array( 'autofocus[panel]' => 'zigcy_lite_footer_page_section' ), admin_url( 'customize.php' ) ),
				),
				array(
					'icon' => 'dashicons-format-aside',
		...
		<div class="step-1-left">
			...
			<p><?php echo esc_html__('Zigcy Lite now comes with a sites library with 3 starter sites to pick from. You can check theme out and decide which one to start with. However you can decide not to use any one of them and start building your site from scratch.', 'zigcy-lite'); ?></p>
